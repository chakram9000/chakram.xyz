...
const hero = {
	...
	"home.hero.name": "محمد أكرم",
	"home.hero.hello": "مرحبًا بكم",
	"home.hero.p1":
		"أنا محمد أكرم، مبرمج للويب (Fullstack)، طالب علوم الحاسوب وتخصص الذكاء الاصطناعي بالجزائر.",
	"home.hero.p2":
...
const projects = {
	...
	"projects.blog.title": "Fullblog (مدونة)",
	"projects.blog.desc":
		"موقع فول ستاك؛ يستطيع الكاتب إضافة وتعديل ونشر وإيقاف نشر المقالات في واجهته الخاصة، ويقرأها زائروا الموقع العام، بالإضافة إلى التعليق والإعجاب لمن له حساب.",
	"project.more": "يمكنكم تصفح باقي المشاريع",
	"project.more-link": "في صفحتي على Github.",
};

const footer = {
	"footer.built-with": "تم بناء هذا الموقع باستخدام Astro.",
	"footer.wip":
		"لا يزال هذا الموقع قيد البناء! نرجو أن تعودوا له بين الفينة والأخرى.",
};
