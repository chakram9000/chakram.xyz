...
const projects = {
	...
	"projects.blog.title": "Fullblog",
	"projects.blog.desc":
		"Fullstack blog; authors post, edit, delete, publish and unpublish posts in their interface, while guests can read them in the public one. Users with an account can also like and comment.",
